...
const RodapeFigure = styled.footer`
    display: flex;
    justify-content: space-between;
    align-items: center;
`

const Imagem = ({ foto, expandida = false, aoSolicitarZoom, aoAlternarFavorito }) => {
        ...
        <Figure $expandida={expandida} id={`foto-${foto.id}`}>
            ...
            <figcaption>
                ...
                <RodapeFigure>
                    ...
                    {!expandida &&
                        <BotaoIcone aria-hidden={expandida} onClick={() => aoSolicitarZoom(foto)}>
